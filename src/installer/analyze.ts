...
If the command pipes the script into \`sudo\` (e.g. \`| sudo sh\`), the WHOLE script runs as root — every behavior executes with root privileges, not just the steps that invoke sudo themselves.
